class Currency:
    # class dictionary that contains exchange rates vs USD
    ...
    # An Currency object is transformed from the unit "self.unit"
    # to "new_unit"
    ...
    def __repr__(self):
    # This method returns the string to be printed. This should
    # be the value rounded to two digits, accompanied by its acronym.
    ...
    # Defines the '+' operator. If other parameter is a Currency object,
    # the currency values are added and the result will be the
    # unit of self. If other is an int or a float, other will be
    ...
    # This method is similar to __add__(self,other), but occurs when
    # an int or float tries to add a Currency object.
    ...
    # Similar to __add__ , but subtrats
    # Defines the '+' operator. If other is a Currency object
    # the currency values are subtracted and the result will
    # be the unit of self. If other is an int or a float,
    ...
    # similat to __sub__ , also see __radd__ code
